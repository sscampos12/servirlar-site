    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-xl text-center">Como você quer se cadastrar?</CardTitle>
            <CardDescription className="text-center">
              Escolha o tipo de perfil que melhor descreve você.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid grid-cols-2 gap-4">
            <Button asChild size="lg" className="h-28 text-base flex-col gap-2">
            ...
            <Button asChild size="lg" variant="secondary" className="h-28 text-base flex-col gap-2">
              <Link href="/register/provider">
                ...
                <span>Sou Profissional</span>
                 <span className="text-xs font-normal text-secondary-foreground/80">Quero ofertar serviços.</span>
              </Link>
            </Button>
          </CardContent>
        </Card>
