// Arquivo: src/components/ClientScheduleForm.tsx

"use client";

import React, { useState, useEffect } from 'react';
import { Loader2, Calendar as CalendarIcon, Clock, Home as HomeIcon } from 'lucide-react';
...
export const ClientScheduleForm = ({ user }: { user: any }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        toast({ title: "Profissionais Notificados!", description: "A solicitação foi enviada a todos." });
        router.push('/dashboard/my-account');

    } catch (error) {
        toast({ variant: "destructive", title: "Erro no Processo", description: "O agendamento foi criado, mas pode ter ocorrido uma falha ao notificar." });
